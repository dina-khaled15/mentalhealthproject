...
export default function Schedule() {
  ...
  <Box sx={{overflow: "hidden",display: "flex",
      ...
      ml: { xs: 0, md: 10 }, 
      mr: { xs: 0, md: 0 },}}>
        <Button variant="outlined" sx={{width: "160px",borderRadius: "20px",border: "1px solid #D3D3D3",color: "#222222",
        backgroundColor: "#fff", alignSelf: "flex-start",fontFamily: "Manrope",fontWeight: 500,textTransform: "none",
  ...
  lg: "700px", // شاشات أكبر شوية
      ...
      alignItems: { xs: "center", md: "flex-end" },}}>
        {schedule.map((day, index) => (
          <Card key={index} variant="outlined"sx={{display: "flex",flexDirection: "column",backgroundColor: "#F8F7F4",borderRadius: "10px",
            width: { xs: "100%", md: "75%" },
            ...
            <Grid item>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <LinearProgress variant="determinate" value={day.booked} sx={{height: 5,borderRadius: 5,
                width: { xs: 70, md: 80 }, 
                backgroundColor: "#CAC8C2",
                '& .MuiLinearProgress-bar': { backgroundColor: "#51504E" },}}/>
                <Typography variant="caption" sx={{fontFamily: "Manrope",fontWeight: 700,
      ...
      <Box sx={{ mt: 0.5, maxHeight: { xs: 90, md: 150 }, overflowY: "auto" }}>
      ...
      <Box sx={{ mb: { xs: 2, md: 7 }, display: "flex", justifyContent: "flex-end" }}> 
        <Button variant="contained" size="small" sx={{marginTop: "10px",fontFamily: "Manrope",borderRadius: "3px",height: "28px",
        textTransform: "none",fontWeight: 700,border: "1px solid",
