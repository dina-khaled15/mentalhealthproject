...
const Navbar = () => {
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.36539 17.5C14.1343 17.5 18.0003 13.6944 18.0003 9C18.0003 4.30558 14.1343 0.5 9.36539 0.5C4.59645 0.5 0.730469 4.30558 0.730469 9C0.730469 13.6944 4.59645 17.5 9.36539 17.5ZM8.14681 4.2C8.14681 3.53726 8.6926 3 9.36586 3C10.0391 3 10.5849 3.53726 10.5849 4.2V6.6C10.5849 7.26274 10.0391 7.8 9.36586 7.8C8.6926 7.8 8.14681 7.26274 8.14681 6.6V4.2ZM4.48967 10.2C3.81641 10.2 3.27062 9.66274 3.27062 9C3.27062 8.33726 3.81641 7.8 4.48967 7.8H6.92776C7.60103 7.8 8.14681 8.33726 8.14681 9C8.14681 9.66274 7.60102 10.2 6.92776 10.2H4.48967ZM14.2421 10.2C14.9153 10.2 15.4611 9.66274 15.4611 9C15.4611 8.33726 14.9153 7.8 14.2421 7.8H11.804C11.1307 7.8 10.5849 8.33726 10.5849 9C10.5849 9.66274 11.1307 10.2 11.804 10.2H14.2421ZM10.5849 13.8C10.5849 14.4627 10.0391 15 9.36586 15C8.6926 15 8.14681 14.4627 8.14681 13.8V11.4C8.14681 10.7373 8.6926 10.2 9.36586 10.2C10.0391 10.2 10.5849 10.7373 10.5849 11.4V13.8Z" fill="#222222"/>
            ...
            <Typography variant="h6" sx={{ fontFamily: "Manrope", fontWeight: "800" }}>
              wellthy
            </Typography>
          </Box>

          {/* Navigation in the middle */}
          <Box sx={{ display: "flex", gap: 4, justifyContent: "center", flexGrow: 2 }}>
            <Button component={Link} to="/" sx={{ color: "#222", fontSize: "16px", fontWeight: "700", fontFamily: "Manrope", textTransform: "none" }}>
              Home
            </Button>
            <Button component={Link} to="/about" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              About us
            </Button>
            <Button component={Link} to="/doctors" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              Doctors
            </Button>
            <Button component={Link} to="/kids" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              Kids
            </Button>
            <Button component={Link} to="/issues" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              Issues
            </Button>
            <Button component={Link} to="/pharmacies" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              Pharmacies
            </Button>
            <Button component={Link} to="/contact" sx={{ color: "inherit", fontSize: "16px", fontWeight: "400", fontFamily: "Manrope", textTransform: "none" }}>
              Contact us
            </Button>
          </Box>

          {/* Login / Register / Icon on the far right */}
          <Box sx={{ display: "flex", gap: 2, alignItems: "center", flexGrow: 1, justifyContent: "flex-end" }}>
            ...
            <Button variant="contained"
              sx={{
                backgroundColor: "black", color: "white", borderRadius: "4px", fontFamily: "Manrope", fontWeight: 600, textTransform: "none",
