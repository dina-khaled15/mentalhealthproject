            ...
            <Grid item xs={12} sm={4} md={4} key={idx} sx={{ mt: 4 }} margin={"auto"}>
              <Link
                ...
                <Card sx={{position: "relative",borderRadius: 2,boxShadow: 3,
                    overflow: "hidden",fontFamily: "Manrope",width: "90%",display: "block"}}>
                  <CardMedia component="img" image={service.image}
                    alt={service.title}
                    sx={{ height: 200,width: 430,objectFit: "cover"}}/>
                  <Box sx={{ position: "absolute",top: 8, left: 8,
                      bgcolor: "rgba(224, 224, 224, 0.7)",px: 1, py: 0.5,borderRadius: 1,}}>
                    <Typography
                      variant="caption"
                      sx={{color: "#000",fontWeight: "bold", fontSize: "0.7rem",fontFamily: "Manrope",}}>
                      {service.category}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{position: "absolute",bottom: 16,width: "100%",textAlign: "center"}}>
                    <Typography variant="subtitle1"
                      sx={{color: "#fff",fontWeight: "bold",textShadow: "1px 1px 3px rgba(0,0,0,0.8)",fontFamily: "Manrope",fontSize: "18px",}}>
                      {service.title}
                    </Typography>
                  </Box>
                </Card>
