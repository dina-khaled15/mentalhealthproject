            ...
            <Container>
                <Grid container spacing={8} justifyContent="space-between">
                    ...
                    <Grid item xs={12} sm={4}>
                        <Typography variant="subtitle1" fontWeight="bold" sx={{ fontSize: "16px", mb: 2 ,fontFamily: "Manrope", fontSize: "16px",
                                fontWeight: 600,}}>
                            Contact Us
                        </Typography>
                        <Typography variant="body2" sx={{ opacity: 0.8, mb: 1 ,fontFamily: "Manrope",lineHeight: "24px", fontSize: "16px",
                                fontWeight: 400,}}>
                        ...
                        <Typography variant="body2" sx={{ opacity: 0.8,fontFamily: "Manrope",
                                fontWeight: 400, }}>
                            (123) 456-7890
                        </Typography>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4} sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <Typography variant="subtitle1" fontWeight="bold" sx={{ fontSize: "16px", mb: 2 ,fontFamily: "Manrope",
                                fontWeight: 600, }}>
                            Quick Links
                        </Typography>
                ...
                {/* WELLTHY Logo (كلمة كبيرة تحت) */}
                <Box mt={8} mb={4} textAlign="center">
                <Typography
    sx={{
        fontFamily: "Manrope",
        fontWeight: 800,
        fontSize: { xs: "64px", sm: "120px" },
        letterSpacing: "16px",
        color: "#FCFCFC",
        lineHeight: 1,
        textAlign: "center",
