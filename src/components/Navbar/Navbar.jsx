...
// import TranslateIcon from "@mui/icons-material/Translate";
// import KeyboardArrowDownIcon from "@mui/icons-material/KeyboardArrowDown";
// import {AppBar,Toolbar,Typography,Button,Box,Container,Dialog,DialogTitle,DialogContent,
//   DialogActions,TextField,IconButton,Divider,Menu,MenuItem,Tooltip,} from "@mui/material";
// import styles from "./Navbar.module.css";
...
//         </Box>
//         <Box className={styles.navLinks}>
//           <Button component={Link} to="/" className={`${styles.navLink} ${currentPath === "/" ? styles.activeNavLink : ""}`}>
//           Home
//           </Button>
//           <Button component={Link} to="/about"className={`${styles.navLink} ${currentPath === "/about" ? styles.activeNavLink : ""}`} >
//           About us
//           </Button>
//           <Button component={Link} to="/doctors" className={`${styles.navLink} ${currentPath === "/doctors" ? styles.activeNavLink : ""}`}>
//           Doctors
//           </Button>
//           <Button component={Link} to="/kids" className={`${styles.navLink} ${currentPath === "/kids" ? styles.activeNavLink : ""}`}>
//           Kids
//           </Button>
//           <Button component={Link} to="/issues" className={`${styles.navLink} ${currentPath === "/issues" ? styles.activeNavLink : ""}`}>
//           Issues
//           </Button>
//           <Button component={Link} to="/pharmacies" className={`${styles.navLink} ${currentPath === "/pharmacies" ? styles.activeNavLink : ""}`}>
//           Pharmacies
//           </Button>
//           <Button component={Link} to="/contact" className={`${styles.navLink} ${currentPath === "/contact" ? styles.active : ""}`}>
//           Contact us
//           </Button>
//           </Box>
//           <Box className={styles.authContainer}>
//             <Tooltip title="Change Language">
//               <Button className={styles.languageButton} onClick={handleLanguageMenuOpen}
//               endIcon={<KeyboardArrowDownIcon />}
//               startIcon={<TranslateIcon className={styles.translateIcon} />}>
//                 {currentLanguage}
//               </Button>
...
//             <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleLanguageMenuClose} className={styles.languageMenu}>
//               {languages.map((lang) => (
...
//   <form onSubmit={handleLoginSubmit}>
//     <DialogContent className={styles.dialogContent}>
//       <TextField autoFocus margin="dense" label="Email" type="email" fullWidth variant="outlined" required
//       className={styles.textField}/>
//       <TextField margin="dense" label="Password" type="password" fullWidth variant="outlined" className={styles.textField} />
//       <Typography variant="body2" className={styles.forgotPassword}>
//         Forgot password?
//       </Typography>
//     </DialogContent>
...
//   </Box>
//   <Box className={styles.socialButtonsContainer}>
//     <Button variant="outlined" startIcon={<GoogleIcon />} onClick={handleGoogleLogin} className={styles.socialButton}> 
//     Continue with Google
//     </Button>
//     <Button variant="outlined" startIcon={<MicrosoftIcon />} onClick={handleMicrosoftLogin} className={styles.socialButton}>
//     Continue with Microsoft
//     </Button>
//   </Box>
//   <Box className={styles.dialogFooter}>
...
//       className={styles.textField}/>
//       <TextField margin="dense" label="Password" type="password" fullWidth variant="outlined"required
//       className={styles.textField}/>
...
//     <Typography variant="body2" className={styles.switchAuthText}>
//       Already have an account?{" "}
//       <span className={styles.switchAuthLink} onClick={() => {
//         handleRegisterClose();
//         handleLoginOpen();
//       }}>
//         Log in
