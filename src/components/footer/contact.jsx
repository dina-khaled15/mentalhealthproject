...
export default function FooterComponent({ variant = "light" }) {
  ...
  return (
  <Box sx={{backgroundColor: isDark ? "#222222" : "#ffffff",color: isDark ? "#ffffff" : "#000000",pt: 4,pb: 2,
        ...
        <Container maxWidth="lg">
          ...
          <Grid item xs={12} sm={4}>
            ...
            <Paper component="form"
              sx={{ borderRadius: "4px",padding: "4px 12px",px: 2,fontFamily: "Manrope",fontWeight: 400,backgroundColor: "#fff",maxWidth: 350}}>
                <InputBase sx={{ flex: 1, fontSize: "14px" }} placeholder="Type your email"
