  ...
  return (
    ...
    >
      <Box textAlign="center" mb={3}>
        <Button
          variant="outlined"
          sx={{color: "white",borderColor: "white",mb: 2,textTransform: "none",borderRadius: "30px",px: 3.5,
            py: 1,fontSize: "16px",fontWeight:"400",fontFamily: "Manrope" ,}}
          startIcon={<Business sx={{ fontSize: "1.5rem", color: "white" ,fontFamily: "Manrope" }} />}
        >
          Vision & Mission
        </Button>
      ...
      <Box
        ...
        width="100%"maxWidth="1100px" mb={4}>
        <Box
          component="img"
          src={visionImage}
          alt="online therapy"
        ...
        <Box sx={{ width: { xs: "100%", md: "50%" }, px: 8, mt: -5}}>
          ...
          <Typography variant="body1" color="#EEEEEE" mb={2} fontFamily={"Manrope"} fontWeight={400} >
      ...
      <Box mt={4} alignSelf="flex-start" px={21} sx={{ minHeight: "100px", pb: 1 }}>
        <Box
          display="flex"
          flexDirection="column"
        ...
        <Typography variant="body1" color="#EEEEEE" maxWidth="700px"  fontWeight={400} fontFamily={"Manrope"} mb={3}>
