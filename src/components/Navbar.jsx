...
const Navbar = () => {
  ...
  `
                        ...
                        <Typography variant="h6" sx={{ fontFamily: "Manrope", fontWeight: "16px",fontWeight: "800" }}>
                            wellthy
                        </Typography>
                    </Box>
                    ...
                    <Box sx={{ display: "flex", gap: 4, color: "#6C6C6C"}}>
                        <Button sx={{ color: "#222222", fontSize: "16px", fontWeight: "700" ,fontFamily: "Manrope" ,textTransform: "none"}}>Home</Button>
                        <Button sx={{ color: "inherit", fontSize: "16px",fontWeight: "400" ,fontFamily: "Manrope" ,textTransform: "none"}}>About us</Button>
                        <Button sx={{ color: "inherit", fontSize: "16px", fontWeight: "400" ,fontFamily: "Manrope" ,textTransform: "none"}}>Doctors</Button>
                        <Button sx={{ color: "inherit", fontSize: "16px",fontWeight: "400" ,fontFamily: "Manrope" ,textTransform: "none"}}>Contact us</Button>
                    </Box>
