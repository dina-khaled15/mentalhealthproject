  ...
  return (
    <div className="container mt-5">
      <Box sx={{ textAlign: 'center', py: 6 }}>
        <Button variant="outlined" startIcon={<RouteIcon />}sx={{fontFamily: 'Manrope', mb: 2, borderRadius: 10 , borderColor: '#D3D3D3', 
        color: 'black',textTransform: "none",boxShadow: 'none',
    '&:hover': {
      bgcolor: '#c0c0c0', // لون أغمق بسيط عند الـ hover
        ...
        <Box
          sx={{display: 'flex',justifyContent: 'space-between',position: 'relative',px: 4,
            mt: 10,
          }}
        >
          <Box
