...
const LocationSection = () => {
    ...
    <Container>
        <Box className={styles.header}>
            <Chip icon={<RoomIcon />} label="On-site Office" color="default" sx={{ mb: 2 }}/>
        ...
        <CardContent className={styles.cardContent}>
            <Typography variant="body2" className={styles.country}>{loc.country}</Typography>
            <Typography variant="h6" className={styles.city} gutterBottom>{loc.city}</Typography>
            <Typography variant="body2" className={styles.address} gutterBottom>{loc.address}</Typography>
