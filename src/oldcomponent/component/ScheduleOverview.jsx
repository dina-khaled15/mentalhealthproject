      ...
      <Grid container spacing={4} justifyContent="center" sx={{ mb: 2 }}>
        {schedule.slice(0, 2).map((slot, index) => (
          <Grid item xs={12} sm={10} md={6} key={index}>
            <Paper
              elevation={1}
              sx={{p: 5,borderRadius: '3px',backgroundColor: '#F8F7F4',minHeight: '20px' }}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={12} sm={8}>
                  <Box textAlign="left"  sx={{ mt: -2 }}>
                    <Typography variant="body1" fontFamily={'Manrope'} fontWeight={600}>{slot.time}</Typography>
                    <Typography
                      variant="body2" color= 'black' fontFamily={'Manrope'} fontSize={20} fontWeight={400} 
                      sx={{ mb: 2, mt: 0.5}}>
                      {slot.location}
                    </Typography>
                    ...
                    <Button
                      variant="outlined"
                      size="small"
                      sx={{color: 'black',borderColor:'black',borderRadius:'4px',backgroundColor:'#F8F7F4',textTransform: 'none', mt: 0.5,
                        '&:hover': {
      ...
      <Grid container spacing={4} justifyContent="center" sx={{ mb: 2 }}>
        {schedule.slice(2).map((slot, index) => (
          <Grid item xs={12} sm={10} md={6} key={index}>
            <Paper
              elevation={1}
              sx={{p: 5,borderRadius: '3px',backgroundColor: '#F8F7F4',minHeight: '20px', mt: 2 }}>
              <Grid container alignItems="center" spacing={2}>
                <Grid item xs={12} sm={4}>
                ...
                <Grid item xs={12} sm={8}>
                  <Box textAlign="left" sx={{ mt: -2 }}>
                    ...
                    <Button
                      variant="outlined"
                      size="small"
                      sx={{color: 'black',borderColor:'black',borderRadius: '4px',backgroundColor: '#F8F7F4',textTransform: 'none',
                        '&:hover': {
                          backgroundColor: '#e6e5e2',
                          borderColor: 'black',
                        },
