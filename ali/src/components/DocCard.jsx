...
export default function DoctorCard() {
  ...
  return (
    <Card sx={{ maxWidth: 292, height: 590, borderRadius: '0', boxShadow: 'none', padding: 0 }}>
      ...
      <CardContent sx={{ padding: '16px 0 16px 0' }}>
        ...
        <Typography variant="body2" sx={{ fontFamily: 'Manrope', color: 'text.secondary', fontSize: 14, marginTop: 2 }}>
